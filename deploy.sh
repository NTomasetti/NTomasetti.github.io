...
git subtree pull --prefix=public \https://github.com/NTomasetti/NTomasetti.github.io.git origin master -m "Merge origin master"
...
git subtree push --prefix=public \https://github.com/NTomasetti/NTomasetti.github.io.git master
